	...
	for (c = m->clients; c; c = c->next) {
		...
		for (i = 0; i < LENGTH(tags); i++)
			if (!masterclientontag[i] && c->tags & (1<<i)) {
				...
				// THIS MOVE TO CONFIG
				if (strcmp(masterclientontag[i], "firefox") == 0)
					masterclientontag[i] = " ";
				if (strcmp(masterclientontag[i], "okular") == 0)
					masterclientontag[i] = " ";
				if (strcmp(masterclientontag[i], "Alacritty") == 0)
					masterclientontag[i] = " ";
				if (strcmp(masterclientontag[i], "thunderbird") == 0)
					masterclientontag[i] = " ";
				if (lcaselbl)
